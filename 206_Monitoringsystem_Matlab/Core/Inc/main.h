...
#define USER_B1_EXTI_IRQn EXTI13_IRQn
#define SPI3_CS4_Pin GPIO_PIN_5
#define SPI3_CS4_GPIO_Port GPIOF
#define SPI3_CS3_Pin GPIO_PIN_13
...
#define SPI3_CS5_Pin GPIO_PIN_10
#define SPI3_CS5_GPIO_Port GPIOC
#define SD_CD_Pin GPIO_PIN_2
#define SD_CD_GPIO_Port GPIOD
#define USART2_REn_Pin GPIO_PIN_3
#define USART2_REn_GPIO_Port GPIOD
