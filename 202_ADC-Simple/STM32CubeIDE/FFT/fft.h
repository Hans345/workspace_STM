...
// Rechenaufwand: O(N^2)
void dft(float x[], Complex c[], int N)
{
	for(int k = 0; k < N; k++)
	{
		// Initalisierung
...
// Fast Fourier Transfromation (FFT)
// c: Komplexe Fourier Koeffizienzten ck
// N: Anzahl Samples
// Rechenaufwand: O(N*log(N))
